                ...
                <div class="tab-pane" id="sidebar-side2">
                    <div class="list-group list-group-flush">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image"
                                    data-bs-image-src="<?php base_url() ?>/../assets/images/users/2.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image"
                                    data-bs-image-src="<?php base_url() ?>/../assets/images/users/11.jpg"><span
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image"
                                    data-bs-image-src="<?php base_url() ?>/../assets/images/users/10.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                                    <div class="fw-semibold text-dark" data-bs-toggle="modal"
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image"
                                    data-bs-image-src="<?php base_url() ?>/../assets/images/users/13.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                                    <div class="fw-semibold text-dark" data-bs-toggle="modal"
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image"
                                    data-bs-image-src="<?php base_url() ?>/../assets/images/users/12.jpg"><span
                                        class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image"
                                    data-bs-image-src="<?php base_url() ?>/../assets/images/users/15.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                                    <div class="fw-semibold text-dark" data-bs-toggle="modal"
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image"
                                    data-bs-image-src="<?php base_url() ?>/../assets/images/users/4.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                                    <div class="fw-semibold text-dark" data-bs-toggle="modal"
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image"
                                    data-bs-image-src="<?php base_url() ?>/../assets/images/users/7.jpg"><span
                                        class="avatar-status bg-success"></span></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image"
                                    data-bs-image-src="<?php base_url() ?>/../assets/images/users/9.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                                    <div class="fw-semibold text-dark" data-bs-toggle="modal"
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="me-2">
                                <span class="avatar avatar-md brround cover-image"
                                    data-bs-image-src="<?php base_url() ?>/../assets/images/users/14.jpg"></span>
                            </div>
                            <div class="">
                                <a href="chat.html">
                                    <div class="fw-semibold text-dark" data-bs-toggle="modal"
                ...
                <ul class="row p-3">
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block active">
                            <span class="country-selector"><img alt="" src="<?php base_url() ?>/../assets/images/flags-img/us_flag.jpg"
                    ...
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt=""
                                src="<?php base_url() ?>/../assets/images/flags-img/italy_flag.jpg"
                    ...
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt=""
                                src="<?php base_url() ?>/../assets/images/flags-img/spain_flag.jpg"
                    ...
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt=""
                                src="<?php base_url() ?>/../assets/images/flags-img/india_flag.jpg"
                    ...
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt=""
                                src="<?php base_url() ?>/../assets/images/flags-img/french_flag.jpg"
                    ...
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt=""
                                src="<?php base_url() ?>/../assets/images/flags-img/russia_flag.jpg"
                    ...
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt=""
                                src="<?php base_url() ?>/../assets/images/flags-img/germany_flag.jpg"
                    ...
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt=""
                                src="<?php base_url() ?>/../assets/images/flags-img/argentina.jpg"
                                class="me-3 language"></span>Argentina
                        </a>
                    </li>
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt="" src="<?php base_url() ?>/../assets/images/flags-img/malaysia.jpg"
                                class="me-3 language"></span>Malaysia
                        </a>
                    </li>
                    <li class="col-lg-6 mb-2">
                        <a href="javascript:void(0)" class="btn btn-country btn-lg btn-block">
                            <span class="country-selector"><img alt="" src="<?php base_url() ?>/../assets/images/flags-img/turkey.jpg"
...
<a href="#top" id="back-to-top"><i class="fa fa-angle-up"></i></a>
    ...
    <!-- INPUT MASK JS-->
    <script src="<?php base_url() ?>/../assets/plugins/input-mask/jquery.mask.min.js"></script>

	<!-- TypeHead js -->
	<script src="<?php base_url() ?>/../assets/plugins/bootstrap5-typehead/autocomplete.js"></script>
    <script src="<?php base_url() ?>/../assets/js/typehead.js"></script>

    <!-- INTERNAL SELECT2 JS -->
    <script src="<?php base_url() ?>/../assets/plugins/select2/select2.full.min.js"></script>

    <!-- DATA TABLE JS-->
    <script src="<?php base_url() ?>/../assets/plugins/datatable/js/jquery.dataTables.min.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/datatable/js/dataTables.bootstrap5.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/datatable/js/dataTables.buttons.min.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/datatable/js/buttons.bootstrap5.min.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/datatable/js/jszip.min.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/datatable/pdfmake/pdfmake.min.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/datatable/pdfmake/vfs_fonts.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/datatable/js/buttons.html5.min.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/datatable/js/buttons.print.min.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/datatable/js/buttons.colVis.min.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/datatable/dataTables.responsive.min.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/datatable/responsive.bootstrap5.min.js"></script>
    <script src="<?php base_url() ?>/../assets/js/table-data.js"></script>

    <!-- Perfect SCROLLBAR JS-->
    <script src="<?php base_url() ?>/../assets/plugins/p-scroll/perfect-scrollbar.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/p-scroll/pscroll.js"></script>
    <script src="<?php base_url() ?>/../assets/plugins/p-scroll/pscroll-1.js"></script>

    <!-- SIDE-MENU JS -->
    <script src="<?php base_url() ?>/../assets/plugins/sidemenu/sidemenu.js"></script>

    <!-- SIDEBAR JS -->
    <script src="<?php base_url() ?>/../assets/plugins/sidebar/sidebar.js"></script>

    <!-- Color Theme js -->
    <script src="<?php base_url() ?>/../assets/js/themeColors.js"></script>

    <!-- Sticky js -->
    <script src="<?php base_url() ?>/../assets/js/sticky.js"></script>

    <!-- CUSTOM JS -->
    <script src="<?php base_url() ?>/../assets/js/custom.js"></script>

    <!-- Custom-switcher -->
    <script src="<?php base_url() ?>/../assets/js/custom-swicher.js"></script>

    <!-- Switcher js -->
    <script src="<?php base_url() ?>/../assets/switcher/js/switcher.js"></script>
