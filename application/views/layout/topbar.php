...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php base_url() ?>/../assets/images/brand/favicon.ico">

    <!-- TITLE -->
    <title>Sash – Bootstrap 5 Admin & Dashboard Template</title>

    <!-- BOOTSTRAP CSS -->
    <link id="style" href="<?php base_url() ?>/../assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="<?php base_url() ?>/../assets/switcher/css/switcher.css" rel="stylesheet">
    <link href="<?php base_url() ?>/../assets/switcher/demo.css" rel="stylesheet">
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div id="global-loader">
        <img src="<?php base_url() ?>/../assets/images/loader.svg" class="loader-img" alt="Loader">
    </div>
    <!-- /GLOBAL-LOADER -->
                                    ...
                                    <div class="d-flex order-lg-2">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <div class="header-dropdown-list message-menu">
                                                    <div class="dropdown-item d-flex p-4">
                                                        ...
                                                        <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image" data-bs-image-src="<?php base_url() ?>/../assets/images/products/3.jpg"></span>
                                                        <div class="wd-50p">
                                                    ...
                                                    <div class="dropdown-item d-flex p-4">
                                                        <a href="cart.html" class="open-file"></a>
                                                        <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image" data-bs-image-src="<?php base_url() ?>/../assets/images/products/5.jpg"></span>
                                                        <div class="wd-50p">
                                                    ...
                                                    <div class="dropdown-item d-flex p-4">
                                                        <a href="cart.html" class="open-file"></a>
                                                        <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image" data-bs-image-src="<?php base_url() ?>/../assets/images/products/7.jpg"></span>
                                                        <div class="wd-50p">
                                                    ...
                                                    <div class="dropdown-item d-flex p-4">
                                                        <a href="cart.html" class="open-file"></a>
                                                        <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image" data-bs-image-src="<?php base_url() ?>/../assets/images/products/1.jpg"></span>
                                                        <div class="wd-50p">
                                                    ...
                                                    <div class="dropdown-item d-flex p-4">
                                                        <a href="cart.html" class="open-file"></a>
                                                        <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image" data-bs-image-src="<?php base_url() ?>/../assets/images/products/2.jpg"></span>
                                                        <div class="wd-50p">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                ...
                                                <div class="message-menu message-menu-scroll">
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php base_url() ?>/../assets/images/users/1.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php base_url() ?>/../assets/images/users/15.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php base_url() ?>/../assets/images/users/12.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php base_url() ?>/../assets/images/users/4.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                                    ...
                                                    <a class="dropdown-item d-flex" href="chat.html">
                                                        <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="<?php base_url() ?>/../assets/images/users/3.jpg"></span>
                                                        <div class="wd-90p">
                                                            <div class="d-flex">
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                                <img src="<?php base_url() ?>/../assets/images/users/21.jpg" alt="profile-user" class="avatar  profile-user brround cover-image">
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
